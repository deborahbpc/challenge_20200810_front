                                        ...
                                        <div class="modal-body">
                                          <form id="form-${product.id}" data-target="table.form" data-index="${index}">
                                            ...
                                            <div class="d-flex justify-content-center">
                                              <button type="submit" data-remote="true" class="btn btn-outline-secondary" data-action="click->table#updateProduct" id="${product.id}" data-url="https://challenge-20200810-v1.herokuapp.com/api/v1/products/${product.id}">Save changes</button>
                                            </div>
                                          </form>
                                        </div>
                                      </div>
